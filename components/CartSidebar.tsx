                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3 border rounded-lg px-2 py-1">
                      <button onClick={() => onUpdateQuantity(item.id, -1)} className="hover:text-green-600">
                        <Minus size={14} />
                      </button>
          ...
          <div className="p-6 border-t bg-gray-50">
            <div className="space-y-2 mb-6 text-sm">
              ...
              <div className="flex justify-between text-gray-600">
                ...
                <span>{deliveryFee === 0 ? <span className="text-green-600 font-bold uppercase text-[10px]">Free</span> : `₹${deliveryFee}`}</span>
              </div>
              <div className="pt-2 border-t flex justify-between text-lg font-black text-gray-900">
                <span>Total</span>
            ...
            <button 
              onClick={onCheckout}
              className="w-full bg-green-600 text-white font-bold py-4 rounded-2xl shadow-lg shadow-green-200 hover:bg-green-700 hover:-translate-y-1 transition-all active:translate-y-0"
            >
              Checkout Now
            </button>
          </div>
